                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            {/* <p className="leading-relaxed mb-4">some text goes here.</p> */}
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900 my-2">
                                    Sub Total: $599
                                </span>
                            </div>
                            <div className="p-4">
                                <button className="flex  text-white bg-pink-500 border-0 py-1 px-10 focus:outline-none hover:bg-pink-600 rounded">
                                    Track Order
                                </button>
                            </div>
